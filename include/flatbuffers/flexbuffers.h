...
class Sized : public Object {
 public:
  ...
  // Manual size.
  Sized(const uint8_t *data, uint8_t byte_width, size_t size) :
    Object(data, byte_width), size_(size) {}
...
class String : public Sized {
 public:
  ...
  // Manual size.
  String(const uint8_t *data, uint8_t byte_width, size_t size)
    : Sized(data, byte_width, size) {}
  ...
  static String EmptyString() {
    return String(reinterpret_cast<const uint8_t *>(""), 1, 0);
  }
